...
const PRODUCT_DATA: Product[] = [
  ...
  {id: 4, name: 'Watch',category:'Furniture',buyingPrice:100,sellingPrice:200,maxDiscount:50,quantity:1,status:'De-activated'},
  ...
  {id: 9, name: 'Watch',category:'Electronic',buyingPrice:100,sellingPrice:200,maxDiscount:50,quantity:1,status:'De-activated'},
